...
$patient_name = '';
$patient_stmt = $conn->prepare("SELECT name FROM patients WHERE id = ? LIMIT 1");
if ($patient_stmt) {
    $patient_stmt->bind_param("i", $patient_id);
    $patient_stmt->execute();
    $patient_stmt->bind_result($patient_name_result);
...
// Log activity
logUserActivity('add_prescription', $prescription_id, null, $patient_name);
